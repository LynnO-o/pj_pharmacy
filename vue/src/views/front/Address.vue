<template>
  <div style="width: 60%; margin: 10px auto">
    <div class="card" style="margin-bottom: 5px; padding: 20px">
      <div style="margin-bottom: 20px; font-size: 24px; font-weight: bold">我的收货地址</div>
      <div style="margin-bottom: 10px">
        <el-button type="primary" @click="handleAdd">新增收货地址</el-button>
      </div>
    ...
    <el-dialog title="收货地址信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="100px" style="padding: 20px">
        <el-form-item prop="name" label="收货人名称">
          <el-input v-model="data.form.name" placeholder="请输入收货人名称"></el-input>
        </el-form-item>
        <el-form-item prop="address" label="收货地址">
          <el-input type="textarea" :rows="3" v-model="data.form.address" placeholder="请输入收货地址"></el-input>
        </el-form-item>
        <el-form-item prop="phone" label="收货电话">
          <el-input v-model="data.form.phone" placeholder="请输入收货电话"></el-input>
        </el-form-item>
