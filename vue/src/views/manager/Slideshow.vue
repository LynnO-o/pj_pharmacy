  ...
  <div>
      ...
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="img" label="图片">
          <template #default="scope">
            <el-image style="width: 100px; height: 50px; display: block; border-radius: 5px" :src="scope.row.img" :preview-src-list="[scope.row.img]" preview-teleported></el-image>
          </template>
        </el-table-column>
    ...
    <el-dialog title="轮播图信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        <el-form-item prop="drugId" label="关联药品">
          <el-select style="width: 100%" v-model="data.form.drugId">
            <el-option v-for="item in data.drugList" :key="item.id" :value="item.id" :label="item.name"></el-option>
          </el-select>
        </el-form-item>
