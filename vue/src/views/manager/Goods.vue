<template>
  <div>
    ...
    <el-dialog title="医用用品信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="90px" style="padding: 20px">
        ...
        <el-form-item prop="store" label="剩余数量">
          <el-input-number style="width:200px" v-model="data.form.store" placeholder="请输入用品数量"></el-input-number>
        </el-form-item>
