      ...
      <el-form ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <el-form-item prop="role">
          <el-select size="large" v-model="data.form.role">
            ...
            <el-option value="DRUGSHOP" label="药店店主"></el-option>
        ...
        <div style="display: flex; align-items: center">
          <div><a style="color: #2779ed" href="/front/home">游客访问</a></div>
          <div style="flex: 1; text-align: right">还没有账号？请 <a style="color: #2779ed" href="/register">注册</a></div>
        </div>
      </el-form>
    </div>
    ...
    if (valid) { // 表示表单校验通过
      request.post('/login', data.form).then(res => {
        if (res.code === '200') {
          ...
          } else if (res.data.role === 'DRUGSHOP') {
            router.push('/manager/noticeView')
          } else {
