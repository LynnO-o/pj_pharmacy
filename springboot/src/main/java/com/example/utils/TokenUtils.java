...
public class TokenUtils {
    ...
    private static DrugShopService staticdrugShopService;
    ...
    public void init() {
        ...
        staticdrugShopService = drugShopService;
    ...
    public static Account getCurrentUser() {
        try {
            ...
            } else if (RoleEnum.DRUGSHOP.name().equals(role)) {
                return staticdrugShopService.selectById(userId);
